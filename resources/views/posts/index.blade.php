...
@section('content')
    <section class="content-header">
        ...
        <h1 class="pull-right">
           <a class="btn btn-primary pull-right" style="margin-top: -10px;margin-bottom: 5px" href="{!! route('posts.create') !!}">Agregar Nuevo</a>
        </h1>
    </section>
    <div class="content">
                ...
                "columnDefs": [
                    {
                        ...
                        "render": function (data, type, row, meta) {
                            return '{!! Form::open(['route' => ['posts.destroy', null], 'method' => 'delete']) !!}<div class="btn-group"><a class="btn btn-default btn-xs" href="/posts/'+ row.post_id+'/edit" data-toggle="tooltip" title="Editar Post"><i class="glyphicon glyphicon-edit"></i></a><button type="submit" class="btn btn-danger btn-xs delete" data-toggle="tooltip" title="Eliminar Post"><i class="glyphicon glyphicon-trash"></i></button></div>{!! Form::close() !!}';
                        }
                    },{
                        "targets" : 0,
                        "width" : "70px"
                        ...
                        "targets": 1,
                        "render": function (data, type, row, meta) {
                            return  '<a href="/blog/'+row.title_slug+'" target="_blank" data-toggle="tooltip" title="Ver Post">'+row.title+'</a>';
                        }
                    }
                ],
                "pageLength": 25,
